...
class DataHolderTest {
    ...
    void part1test() throws IOException {
        DataHolder dataHolder = DataHolder.loadFrom("/2020/day19-test.txt");
    ...
    void part2test1() throws IOException {
        DataHolder dataHolder = DataHolder.loadFrom("/2020/day19-test2-1.txt");
        int count = dataHolder.complyingCount();
    ...
    void part2test2() throws IOException {
        DataHolder dataHolder = DataHolder.loadFrom("/2020/day19-test2-2.txt");
        int count = dataHolder.complyingCount();
